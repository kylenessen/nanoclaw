...
const SEND_MESSAGE_COUNTER_FILE = path.join(IPC_DIR, 'send_message_count');
...
server.tool(
  'send_photo',
  "Send a photo from the filesystem to the user or group. The file must exist on disk (use absolute paths). Supports JPEG, PNG, WebP, and GIF.",
  {
